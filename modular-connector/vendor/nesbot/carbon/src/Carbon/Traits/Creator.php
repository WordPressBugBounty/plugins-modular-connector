...
trait Creator
{
    ...
    public function __construct($time = null, $tz = null)
    {
        ...
        // If the class has a test now set and we are trying to create a \Modular\ConnectorDependencies\now()
     ...
     *
     * If any of $year, $month or $day are set to null their \Modular\ConnectorDependencies\now() values will
     * be used.
     *
     * If $hour is null it will be set to its \Modular\ConnectorDependencies\now() value and the default
     * values for $minute and $second will be their \Modular\ConnectorDependencies\now() values.
     *
