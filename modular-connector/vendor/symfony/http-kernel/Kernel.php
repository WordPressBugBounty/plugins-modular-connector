...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function buildContainer()
    {
        ...
        if (null !== $cont = $this->registerContainerConfiguration($this->getContainerLoader($container))) {
            \Modular\ConnectorDependencies\trigger_deprecation('symfony/http-kernel', '5.3', 'Returning a ContainerBuilder from "%s::registerContainerConfiguration()" is deprecated.', get_debug_type($this));
    ...
    {
        if (!\function_exists('token_get_all') && !\function_exists('Modular\ConnectorDependencies\token_get_all')) {
            return $source;
        }
        $rawChunk = '';
        $output = '';
