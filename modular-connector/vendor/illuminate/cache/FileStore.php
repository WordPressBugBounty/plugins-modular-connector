...
use Modular\ConnectorDependencies\Illuminate\Filesystem\LockableFile;
...
class FileStore implements Store, LockProvider
{
    ...
    public function increment($key, $value = 1)
    {
        ...
        return \Modular\ConnectorDependencies\tap((int) $raw['data'] + $value, function ($newValue) use ($key, $raw) {
    ...
    protected function getPayload($key)
    {
        ...
        try {
            $expire = substr($contents = $this->files->get($path, \true), 0, 10);
        } catch (Exception $e) {
