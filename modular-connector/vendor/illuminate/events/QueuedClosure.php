...
class QueuedClosure
{
    ...
    public function resolve()
    {
        return function (...$arguments) {
            \Modular\ConnectorDependencies\dispatch(new CallQueuedListener(InvokeQueuedClosure::class, 'handle', ['closure' => SerializableClosureFactory::make($this->closure), 'arguments' => $arguments, 'catch' => \Modular\ConnectorDependencies\collect($this->catchCallbacks)->map(function ($callback) {
