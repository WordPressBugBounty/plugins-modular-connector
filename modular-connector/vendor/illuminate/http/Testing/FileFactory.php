...
class FileFactory
{
    ...
    public function create($name, $kilobytes = 0, $mimeType = null)
    {
        ...
        return \Modular\ConnectorDependencies\tap(new File($name, tmpfile()), function ($file) use ($kilobytes, $mimeType) {
    ...
    {
        return \Modular\ConnectorDependencies\tap(tmpfile(), function ($temp) use ($width, $height, $extension) {
            ob_start();
