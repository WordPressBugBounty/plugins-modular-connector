...
class DumpCommand extends Command
{
    ...
    public function handle(ConnectionResolverInterface $connections, Dispatcher $dispatcher)
    {
        ...
        if ($this->option('prune')) {
            (new Filesystem())->deleteDirectory(\Modular\ConnectorDependencies\database_path('migrations'), $preserve = \false);
    ...
    {
        return \Modular\ConnectorDependencies\tap($this->option('path') ?: \Modular\ConnectorDependencies\database_path('schema/' . $connection->getName() . '-schema.dump'), function ($path) {
