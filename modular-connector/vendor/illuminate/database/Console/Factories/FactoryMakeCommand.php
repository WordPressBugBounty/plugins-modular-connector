...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    {
        $factory = \Modular\ConnectorDependencies\class_basename(Str::ucfirst(str_replace('Factory', '', $name)));
        $namespaceModel = $this->option('model') ? $this->qualifyModel($this->option('model')) : $this->qualifyModel($this->guessModelName($name));
        $model = \Modular\ConnectorDependencies\class_basename($namespaceModel);
    ...
    protected function guessModelName($name)
    {
        ...
        if (is_dir(\Modular\ConnectorDependencies\app_path('Models/'))) {
