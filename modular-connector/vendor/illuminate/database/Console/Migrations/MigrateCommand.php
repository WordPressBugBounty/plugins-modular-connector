...
class MigrateCommand extends BaseCommand
{
    ...
    protected function schemaPath($connection)
    {
        ...
        if (file_exists($path = \Modular\ConnectorDependencies\database_path('schema/' . $connection->getName() . '-schema.dump'))) {
            return $path;
        }
        return \Modular\ConnectorDependencies\database_path('schema/' . $connection->getName() . '-schema.sql');
    }
}
