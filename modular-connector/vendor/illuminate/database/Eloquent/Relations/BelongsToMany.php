...
class BelongsToMany extends Relation
{
    ...
    protected function resolveTableName($table)
    {
        ...
        if (in_array(AsPivot::class, \Modular\ConnectorDependencies\class_uses_recursive($model))) {
            $this->using($table);
        }
    ...
    {
        return Str::camel(Str::pluralStudly(\Modular\ConnectorDependencies\class_basename($this->getParent())));
    }
    /**
