...
abstract class Factory
{
    ...
    {
        $guess = Str::camel(Str::plural(\Modular\ConnectorDependencies\class_basename($related)));
    ...
    {
        return $this->newInstance(['has' => $this->has->concat([new BelongsToManyRelationship($factory, $pivot, $relationship ?: Str::camel(Str::plural(\Modular\ConnectorDependencies\class_basename($factory instanceof Factory ? $factory->modelName() : Collection::wrap($factory)->first()))))])]);
    }
    /**
    ...
    {
        return $this->newInstance(['for' => $this->for->concat([new BelongsToRelationship($factory, $relationship ?: Str::camel(\Modular\ConnectorDependencies\class_basename($factory instanceof Factory ? $factory->modelName() : $factory)))])]);
    }
    /**
    ...
    public function modelName()
    {
        $resolver = static::$modelNameResolver ?: function (self $factory) {
            ...
            $factoryBasename = Str::replaceLast('Factory', '', \Modular\ConnectorDependencies\class_basename($factory));
