...
trait HasRelationships
{
    ...
    public function joiningTable($related, $instance = null)
    {
        ...
        $segments = [$instance ? $instance->joiningTableSegment() : Str::snake(\Modular\ConnectorDependencies\class_basename($related)), $this->joiningTableSegment()];
    ...
    {
        return Str::snake(\Modular\ConnectorDependencies\class_basename($this));
    }
    /**
