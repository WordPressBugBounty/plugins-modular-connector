...
if (!\function_exists('Modular\ConnectorDependencies\data_fill')) {
    ...
    {
        return \Modular\ConnectorDependencies\data_set($target, $key, $value, \false);
    }
}
        ...
        if (($segment = \array_shift($segments)) === '*') {
            ...
            if ($segments) {
                foreach ($target as &$inner) {
                    \Modular\ConnectorDependencies\data_set($inner, $segments, $value, $overwrite);
                }
            } elseif ($overwrite) {
                foreach ($target as &$inner) {
                    $inner = $value;
            ...
            if ($segments) {
                ...
                \Modular\ConnectorDependencies\data_set($target[$segment], $segments, $value, $overwrite);
