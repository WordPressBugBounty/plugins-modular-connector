...
trait EnumeratesValues
{
    ...
    public function reduceSpread(callable $callback, ...$initial)
    {
        ...
        foreach ($this as $key => $value) {
            ...
            if (!is_array($result)) {
                throw new UnexpectedValueException(sprintf("%s::reduceMany expects reducer to return an array, but got a '%s' instead.", \Modular\ConnectorDependencies\class_basename(static::class), gettype($result)));
            }
        }
        return $result;
    }
