...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    {
        return \Modular\ConnectorDependencies\collect(token_get_all($contents))->pluck(0)->filter(function ($token) {
    ...
    public function component($class, $alias = null, $prefix = '')
    {
        ...
        if (is_null($alias)) {
            ...
            })->implode(':') : Str::kebab(\Modular\ConnectorDependencies\class_basename($class));
        }
        if (!empty($prefix)) {
            $alias = $prefix . '-' . $alias;
        }
