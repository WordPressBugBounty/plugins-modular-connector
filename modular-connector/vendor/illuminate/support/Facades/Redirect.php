...
/**
 * @method static \Illuminate\Http\RedirectResponse \Modular\ConnectorDependencies\action(string $action, mixed $parameters = [], int $status = 302, array $headers = [])
 * @method static \Illuminate\Http\RedirectResponse away(string $path, int $status = 302, array $headers = [])
 * @method static \Illuminate\Http\RedirectResponse \Modular\ConnectorDependencies\back(int $status = 302, array $headers = [], $fallback = false)
 ...
 * @method static \Illuminate\Http\RedirectResponse \Modular\ConnectorDependencies\route(string $route, mixed $parameters = [], int $status = 302, array $headers = [])
