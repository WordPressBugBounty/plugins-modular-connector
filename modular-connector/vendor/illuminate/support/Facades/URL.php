 ...
 * @method static string \Modular\ConnectorDependencies\action(string|array $action, $parameters = [], bool $absolute = true)
 * @method static string \Modular\ConnectorDependencies\asset(string $path, bool $secure = null)
 ...
 * @method static string \Modular\ConnectorDependencies\route(string $name, $parameters = [], bool $absolute = true)
