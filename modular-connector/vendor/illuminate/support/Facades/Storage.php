 ...
 * @method static \Symfony\Component\HttpFoundation\StreamedResponse \Modular\ConnectorDependencies\response(string $path, string|null $name = null, array|null $headers = [], string|null $disposition = 'inline')
 ...
 * @method static string \Modular\ConnectorDependencies\url(string $path)
