 ...
 * @method static \Illuminate\Routing\Route \Modular\ConnectorDependencies\redirect(string $uri, string $destination, int $status = 302)
 * @method static \Illuminate\Routing\Route substituteBindings(\Illuminate\Support\Facades\Route $route)
 * @method static \Illuminate\Routing\Route \Modular\ConnectorDependencies\view(string $uri, string $view, array $data = [], int|array $status = 200, array $headers = [])
