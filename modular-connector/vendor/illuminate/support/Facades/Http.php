...
/**
 * @method static \GuzzleHttp\Promise\PromiseInterface \Modular\ConnectorDependencies\response($body = null, $status = 200, $headers = [])
 ...
 * @method static \Illuminate\Http\Client\PendingRequest \Modular\ConnectorDependencies\retry(int $times, int $sleep = 0, ?callable $when = null)
 ...
 * @method static \Illuminate\Http\Client\Response \Modular\ConnectorDependencies\head(string $url, array|string|null $query = null)
