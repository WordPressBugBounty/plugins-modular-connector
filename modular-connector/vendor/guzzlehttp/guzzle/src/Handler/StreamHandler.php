...
class StreamHandler
{
    ...
    private function createStream(RequestInterface $request, array $options)
    {
        ...
        return $this->createResource(function () use ($uri, $contextResource, $context, $options, $request) {
            ...
            if (function_exists('Modular\ConnectorDependencies\http_get_last_response_headers')) {
                /** @var array|null */
                $http_response_header = \Modular\ConnectorDependencies\http_get_last_response_headers();
            }
